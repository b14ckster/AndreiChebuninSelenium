package hw6.tests.ex1;

import static hw6.DataClassTest.BASE_URL;
import static hw6.DataClassTest.BENEFIT_TEXTS;
import static hw6.DataClassTest.BROWSER_TITLE;
import static hw6.DataClassTest.HEADER_ITEMS_NAMES;
import static hw6.DataClassTest.ITEMS_IN_SIDEBAR_MENU;
import static hw6.DataClassTest.NUMBER_OF_BENEFIT_IMAGES_AND_TEXTS;

import hw6.BaseClassTest;
import hw6.listeners.AllureListener;
...
public class HomePageTest extends BaseClassTest {
    ...
    @Test(description = "Testing Home page elements")
